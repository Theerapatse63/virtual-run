...
<body>
  ...
  <?php
              ...
              <table class="table">
                  <thead class="thead-dark">
                  <th><img src="event_img/<?php echo $row['souvenir_image']?>" BORDER="2"	WIDTH="250" HEIGHT="200" ALIGN="top" style="position: relative; top:0px; left: 440px;"></th>
                    <tr>
                    ...
                    <th> ราคา : <?php echo $row['souvenir_price'];
                                    $_SESSION['souvenir_price'] = $row['souvenir_price'];?> บาท</th>
                    </tr>
                    <tr>
                    <th >เบอร์โทรศัพท์ :</th>
                    ...
                    <tr>
                    <th> หมายเลขสินค้า : <?php echo $row['souvenir_id'];
              ...
              <h><img src="slip_img/QR.png" BORDER="2"	WIDTH="25%" HEIGHT="25%" ALIGN="top" style="position: relative; top:-40px; left: 470px;  border-radius: 3px;"></h>
              ...
              <div class="text-left justify-content-center align-items-center p-4 border-2 border-dashed rounded-0">
                    ...
                    <div class="d-sm-flex justify-content-end mt-2">
                        ...
                        <a href= "showsouvenir.php" class="btn btn-sm btn-default mb-3">back</a>
                    </div>
                    </form>
                        </div>
                    </div>
