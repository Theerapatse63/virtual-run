...
<body>
    ...
    <h><img src="slip_img/QR.png" BORDER="2"	WIDTH="200" HEIGHT="200" ALIGN="top" style="position: relative; top:10px; left: 40%;  border-radius: 3px;"></h>
    <?php
    
              ?>
 
              <div class="container"><br>
                    <b>หมายเลขกิจกรรม : <?php echo $row['event_id'];?></b><br>
                    <b>ชื่อกิจกรรม :<?php echo $row['event_name']?></b><br>
                    <b>ชื่อจริง :<?php echo $row['fname']?></b><br>
                    <b>นามสกุล :<?php echo $row['lname']?></b><br>
                    <b>ราคา :<?php echo $row['price']?> บาท</b>
        <div class="row mt-5">
            <div class="col-12">
