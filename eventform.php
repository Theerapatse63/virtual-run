            ...
            <div class="col-12">
                <form action="event.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="text-left justify-content-center align-items-center p-4 border-2 border-dashed rounded-0">
                        <input type="event_name" class="input-field" name="event_name" placeholder="ชื่อกิจกรรม" required>
                        <input type="location" class="input-field" name="location" placeholder="สภานที่" required>
                        <input type="text" class="input-field" name="organizer_phone_number" value="<?php echo $phone_number ?>" disabled>
                        <input type="objective" class="input-field" name="objective" placeholder="วุตถุประสงค์" required>
                        <input type="distance" class="input-field" name="distance" placeholder="ระยะทาง(กิโลเมตร)" required>
                        <input type="limit_number" class="input-field" name="limit_number" placeholder="จำนวนที่เปิดรับ" required>
                        <input type="price" class="input-field" name="price" placeholder="ราคา" required>
                        ...
                        <label for="sovenir"><span>เพิ่มของที่ระลึกของอีเว้น</span></label><br>
                    </div>
                    <div class="d-sm-flex justify-content-end mt-2">
                        <input type="submit" name="submit" value="Submit" class="btn btn-sm btn-danger mb-3"> 
                        <a href= "index.php" class="btn btn-sm btn-default mb-3">back</a>
                    </div>
                </form>
            </div>
        </div>
