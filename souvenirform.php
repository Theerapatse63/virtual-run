            ...
            <div class="col-12">
                <form action="souvenir.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="text-left justify-content-center align-items-center p-4 border-2 border-dashed rounded-0">
                        <input type="text" class="input-field" name="souvenir_name" placeholder="ชื่อ" required>
                        <input type="text" class="input-field" name="price" placeholder="ราคา" required>
                        <input type="text" class="input-field" name="details" placeholder="รายละเอียด" required>
                        <input type="text" class="input-field" name="event_id" value="<?php echo $event_id ?>(หมายเลขกิจกรรม)"disabled required>
