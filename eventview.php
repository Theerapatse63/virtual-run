    ...
    <?php
         while($row = mysqli_fetch_array($results)){
            ...
            <tr>
                ...
                <td><?=$row['number_of_participants']?> คน</td>
                <td><?=$row['limit_number']?> คน</td>
                <td><a href="participant.php?event_id=<?=$row['event_id']?>" class="submit-btn" style="color: black;">ดู</a></td>
                <td><?=$row['price']?> บาท</td>
